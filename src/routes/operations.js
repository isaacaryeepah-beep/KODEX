...
router.get("/timesheets/my", ...mw, asyncHandler(async (req, res) => {
...
router.post("/timesheets/my/entry", ...mw, asyncHandler(async (req, res) => {
...
// SUBMIT timesheet
router.post("/timesheets/my/submit", ...mw, asyncHandler(async (req, res) => {
...
router.get("/timesheets", ...mw, canManage, asyncHandler(async (req, res) => {
...
router.patch("/timesheets/:id/review", ...mw, canManage, asyncHandler(async (req, res) => {
...
router.get("/timesheets/:id/export", ...mw, canManage, asyncHandler(async (req, res) => {
...
// GET all assets
router.get("/assets", ...mw, asyncHandler(async (req, res) => {
...
// CREATE asset
router.post("/assets", ...mw, canManage, asyncHandler(async (req, res) => {
...
router.patch("/assets/:id/assign", ...mw, canManage, asyncHandler(async (req, res) => {
