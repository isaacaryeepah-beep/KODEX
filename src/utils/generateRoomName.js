 ...
 * Format: dikly_{shortCompanyId}_{shortMeetingRef}_{randomHash}
 * Example: dikly_a1b2c3_m4d5e6_x8j4pq
 */
exports.generateRoomName = (companyId, meetingRef = '') => {
  ...
  const parts         = ['dikly', companyShort, meetingShort, randomHash].filter(Boolean);
