...
const attendanceSummaryRoutes   = require("./routes/attendanceSummary");
const hrAssignmentRoutes        = require("./routes/hrAssignments");
...
app.use("/api/hr-assignments",       hrAssignmentRoutes);
