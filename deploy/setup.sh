...
cp "${APP_DIR}/deploy/nginx-dikly.conf" /etc/nginx/sites-available/dikly
cp "${APP_DIR}/deploy/nginx-jitsi.conf" /etc/nginx/sites-available/jitsi
...
echo "       certbot --nginx -d dikly.live -d www.dikly.live -d meet.dikly.live"
echo ""
