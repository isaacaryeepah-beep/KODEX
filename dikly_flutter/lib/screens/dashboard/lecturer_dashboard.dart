    ...
    return ListView(
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            WebStatCard(label: 'My Courses', value: '${_courses.length}', subtitle: 'Active', color: const Color(0xFF7C3AED), icon: Icons.school_outlined),
            WebStatCard(label: 'Live Now', value: '${liveMeetings.length}', subtitle: liveMeetings.isNotEmpty ? 'In progress' : 'None active', color: DiklyColors.success, icon: Icons.fiber_manual_record_rounded),
            WebStatCard(label: 'Upcoming', value: '${upcomingMeetings.length}', subtitle: 'Scheduled', color: DiklyColors.warning, icon: Icons.schedule_outlined),
            WebStatCard(label: 'Total Sessions', value: '${_meetings.length}', subtitle: 'All time', color: DiklyColors.primary, icon: Icons.video_call_outlined),
          ],
        ),
        const SizedBox(height: 20),
        // Quick Actions
