      ...
      children: [
        ...
        DiklyFadeIn(
          ...
          child: GridView.count(
            ...
            children: [
              DiklyGradientStat(value: '${d['totalStudents'] ?? 0}', label: 'Total Students', icon: Icons.people_rounded, color: _theme.primary),
              DiklyGradientStat(value: '${d['activeCourses'] ?? 0}', label: 'Active Courses', icon: Icons.school_rounded, color: const Color(0xFF059669)),
              DiklyGradientStat(value: '${d['totalSessions'] ?? 0}', label: 'Sessions Run', icon: Icons.video_call_rounded, color: const Color(0xFF0891B2)),
              DiklyGradientStat(value: '${d['quizzesCreated'] ?? 0}', label: 'Quizzes Created', icon: Icons.quiz_rounded, color: const Color(0xFF7C3AED)),
            ],
          ),
        ),
        const SizedBox(height: 22),
