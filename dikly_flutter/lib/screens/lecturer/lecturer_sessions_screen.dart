...
final _lecturerSessionsProvider = FutureProvider.autoDispose<List<AttendanceSession>>(
...
class LecturerSessionsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(_lecturerSessionsProvider);
    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        error: (e, _) => DiklyErrorView(message: e.toString(), onRetry: () => ref.invalidate(_lecturerSessionsProvider)),
        data: (sessions) => RefreshIndicator(
          onRefresh: () async => ref.invalidate(_lecturerSessionsProvider),
          child: ListView(
            ...
            children: [
              DiklyScreenHeader(
                ...
                action: ElevatedButton(
                  ...
                  child: const Text('Start New Session', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                ),
              ),
              DiklyCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Row(
                            children: [
                              SizedBox(width: 130, child: Text('TITLE', style: _headerStyle)),
                              SizedBox(width: 80, child: Text('COURSE', style: _headerStyle)),
...
class _SessionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final courseLabel = session.courseName ?? session.courseId ?? '—';
          ...
          SizedBox(
            ...
            child: courseLabel != '—'
                ? Container(
                    ...
                    child: Text(courseLabel, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: Color(0xFF2563EB)), overflow: TextOverflow.ellipsis),
                  )
