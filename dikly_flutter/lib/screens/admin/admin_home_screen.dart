      ...
      children: [
        ...
        DiklyFadeIn(
          ...
          child: GridView.count(
            ...
            children: [
              WebStatCard(value: '${d['totalUsers'] ?? 0}', label: 'Total Users', subtitle: 'Students, lecturers & staff', icon: Icons.people_rounded, color: _theme.primary),
              WebStatCard(value: '${d['activeSessions'] ?? 0}', label: 'Active Sessions', subtitle: (d['activeSessions'] ?? 0) > 0 ? 'Live now' : 'No active sessions', icon: Icons.video_call_rounded, color: const Color(0xFF059669)),
              WebStatCard(value: '${d['totalSessions'] ?? 0}', label: 'All Sessions', subtitle: 'All time', icon: Icons.history_rounded, color: const Color(0xFF0891B2)),
              WebStatCard(value: '${d['pendingApprovals'] ?? 0}', label: 'Pending Approvals', subtitle: 'All clear', icon: Icons.pending_rounded, color: const Color(0xFFD97706)),
            ],
          ),
        ),
        const SizedBox(height: 22),
