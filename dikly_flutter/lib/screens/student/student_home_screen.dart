      ...
      children: [
        ...
        DiklyFadeIn(
          ...
          child: GridView.count(
            ...
            children: [
              WebStatCard(value: '${d['totalCheckIns'] ?? 0}', label: 'Total Check-ins', subtitle: 'This semester', icon: Icons.fact_check_rounded, color: _theme.primary),
              WebStatCard(value: '${d['attendanceRate'] ?? 0}%', label: 'Attendance Rate', subtitle: (d['attendanceRate'] ?? 0) >= 80 ? 'Good standing' : 'Needs improvement', icon: Icons.trending_up_rounded, color: const Color(0xFF059669)),
              WebStatCard(value: '${d['enrolledCourses'] ?? 0}', label: 'Enrolled Courses', subtitle: 'Active', icon: Icons.school_rounded, color: const Color(0xFF0891B2)),
              WebStatCard(value: '${d['quizzesTaken'] ?? 0}', label: 'Quizzes Taken', subtitle: 'Completed', icon: Icons.quiz_rounded, color: const Color(0xFFD97706)),
            ],
          ),
        ),
        const SizedBox(height: 22),
